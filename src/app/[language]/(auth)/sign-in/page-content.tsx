...
import { withPageRequiredGuest } from "@/services/auth";
import { useCredentialsLogin } from "@/services/api/auth";

import { useTranslation } from "@/services/i18n/client";
import Divider from "@mui/material/Divider";
import Chip from "@mui/material/Chip";
import SocialAuth from "@/services/auth/social-auth/social-auth";
...
function Form() {
  ...
  const fetchAuthLogin = useCredentialsLogin();
